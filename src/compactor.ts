//@ts-nocheck
const compactNode = (k:any, vertices:any, ends:any, vertexCoords:any, edgeData:any, trackIncoming:any, options:any) => {
    options = options || {};
...
const compactGraph = (vertices:any, vertexCoords:any, edgeData:any, options:any) => {
    options = options || {};
...
const findNextEnd = (prev:any, v:any, vertices:any, ends:any, vertexCoords:any, edgeData:any, trackIncoming:any, options:any) => {

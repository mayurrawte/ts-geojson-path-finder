...
import roundCoord from './roundCord';


export const geoJsonReduce = (geojson:any, fn:any, seed:any) => {
...
export const geoJsonFilterFeatures = (geojson:any, fn:any) => {
    var features = [];
    if (geojson.type === 'FeatureCollection') {
...
export const isLineString = (f:any) => {
    return f.geometry.type === 'LineString';
}

export const topology = (geojson:any, options:any)  => {
    options = options || {};
